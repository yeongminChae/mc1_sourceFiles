...
struct Story8: View {
    ...
    private var soundManager = AVPlayer(url:URL(string:  "https://migusdn.github.io/Noahs_Ark/Resources/story8_MaskOff.mp3")!)
...
struct Story8_Previews: PreviewProvider {
    static var previews: some View {
        Story8().previewInterfaceOrientation(.landscapeRight)
    }
}
